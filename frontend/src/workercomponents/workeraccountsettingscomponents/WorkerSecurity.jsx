...
export default function WorkerSecurity() {
  ...
  const clearWorkerStorage = () => {
    ...
    localStorage.removeItem("worker_auth_uid");
  ...
  const doUpdate = async () => {
    ...
    try {
      ...
      await axios.post(`${API_BASE}/api/account/password`, form, { withCredentials: true, headers: appU ? { "x-app-u": appU } : {} });
            ...
            <div className="space-y-1.5">
              ...
              <div className="mt-2">
                ...
                <ul className="mt-2 grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                  <li className={rules.len ? "text-emerald-600" : "text-gray-500"}>At least 12 characters</li>
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-gray-200 p-4">
                ...
                <ul className="space-y-1 text-sm">
                  <li className={rules.len ? "text-emerald-600" : "text-gray-600"}>12+ characters</li>
