...
export default function WorkerProfile() {
  ...
  const instagramValid=useMemo(()=>{ if(!form.instagram)return true; try{ const u=new URL(/^https?:\/\//i.test(form.instagram)?form.instagram:`https://${form.instagram}`); const h=u.hostname.toLowerCase(); const ok=h==="instagram.com"||h==="www.instagram.com"||"m.instagram.com"; if(!ok) return false; if(u.pathname==="/")return false; return /^\/[A-Za-z0-9._]+\/?$/.test(u.pathname); }catch{return false;} },[form.instagram]);
