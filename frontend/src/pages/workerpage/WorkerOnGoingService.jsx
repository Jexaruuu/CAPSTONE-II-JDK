...
export default function WorkerOnGoingService() {
  ...
  const clientEmail = pick(clientObj, ['email_address', 'email']) || '';
  ...
  const hasAssigned = useMemo(() => {
    const any = pick(clientObj, ['email_address','email','first_name','firstName','last_name','lastName','profile_picture_url','profile_picture']);
    return Boolean(any);
  }, [clientObj]);
      ...
      {!hasAssigned ? (
        <div className="min-h-screen bg-white flex items-center justify-center px-6">
          <div className="text-center">
            ...
            <div className="mt-4 text-base md:text-lg font-semibold text-gray-500">There is no On-going service yet.</div>
          </div>
        </div>
      ) : (
        <div className="min-h-screen bg-white pb-24">
              ...
              <div className="flex items-center gap-4 max-w-[55%]">
                <>
                  ...
                  <div className="min-w-0 text-right">
                    <div className="text-[11px] md:text-xs text-gray-600">Client</div>
          ...
          <div className="mx-auto w-full max-w-[1420px] px-6">
            ...
            <div className="space-y-6 mt-6">
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm ring-1 ring-black/5 overflow-hidden">
                <div className="flex items-center justify-between px-6 py-4">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900">Client Information</h3>
                </div>
                <div className="border-t border-gray-100" />
                <div className="px-6 py-6">
