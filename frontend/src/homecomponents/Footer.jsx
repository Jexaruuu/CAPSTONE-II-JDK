...
const Footer = () => {
  return (
    <footer className="bg-[#0f1113] text-white py-16 mt-5">
      <div className="max-w-[1525px] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center mb-1">
            <img src="/jdklogowhite.png" alt="Logo" className="h-8 mr-2" />
            <span className="text-2xl font-semibold text-[#008cfc]">
          ...
          <p className="text-sm text-justify text-gray-400 mb-4 mt-7">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4 ml-16">Quick Links</h3>
