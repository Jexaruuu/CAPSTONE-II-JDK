...
const ClientPost = () => {
  return (
    <div className="max-w-[1525px] mx-auto bg-white px-6 py-8">
      {/* Welcome Message */}
      <h2 className="text-2xl font-semibold mb-10">Welcome back, Jex</h2>

      {/* Overview Section */}
      <div className="mb-8">
        <h3 className="text-xl font-semibold mb-4">Service Request Post</h3>

        <div className="bg-white border border-gray-200 rounded-lg p-6 text-center shadow-sm">
          <div className="flex justify-center mb-4">
            <img
              src="/jobpost.png" // Replace with your actual image path
              alt="Job Post"
