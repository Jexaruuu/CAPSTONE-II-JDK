...
const handleGoDashboard = () => {
  ...
  jumpTop(); // ⬅️ ensure we’re at top right before the route change

  navigate('/clientdashboard', {
    state: { submitted: true, request_group_id: requestGroupId, __forceTop: true }, // optional flag if your dashboard reads it
    replace: true, // optional: avoids a "back" into the success modal
  });
};
